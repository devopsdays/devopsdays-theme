...
| cfp_link                | String     | No       | If you have a custom link for submitting proposals, add it here. This will control the Propose menu item as well as the "Propose" button.                                                                                     | "https://devopsdaysdc2017.busyconf.com/proposals/new" |
...
| registration_link       | String     | No       | If you have a custom registration link, enter it here. This will control the Registration menu item as well as the "Register" button.                                                                                         | "https://devopsdaysdc2017.busyconf.com/bookings/new"  |                                                                                   |
